...
在GITHUB，會尋到這個image2cpp的工具:<br>
https://github.com/javl/image2cpp<br>
<br>在裡面有個online版的image2cpp (http://javl.github.io/image2cpp)。大家可以在GITHUB直接download他們的HTML檔案使用，又或直接使用他們的online版。
<p><p>
