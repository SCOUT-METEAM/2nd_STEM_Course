...
從造個例子，可以知道.begin() function就是有啟動功能。在DHT11 Library，也有.begin()的function。而這個.begin()放在Void Setp()內，在Arduino UNO3一通電後便可以即時啟動<B>一次</B>。使到DHT11 溫度濕度感應器便可以在Arduino UNO3通電後即時啟動，進行之後量度。
<p>  
<h1>應用例子</h1><p>
